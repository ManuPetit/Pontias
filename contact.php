<?php # script : contact.php
	...
	if ($lang=='fr')
	{
		$breadcrumb='<a href="contact.php" title="Allez &agrave; la page de contact..." class="breadcrumb">Contacts</a>';
		$titre="Contactez-nous";
	}
	else
	{
		$breadcrumb='<a href="contact.php" title="Go to the contact page..." class="breadcrumb">Contacts</a>';
		$titre="Contact us";
	}
	$_SESSION['menuCat']=8;
	...
	//inclure le fichier séparé des contacts
	$fichierM=$lang.'contact';
