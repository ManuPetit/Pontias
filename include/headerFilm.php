...
<div id="global">
  ...
  echo '<img src="css/temp102/'.$image.'" width="830" height="271" border="0" usemap="#Map" />
    <map name="Map" id="Map">
	  ...
	  echo $_SESSION['fichier'].'?lan=1'.$exten. '" alt="Version Française" title="Version Française" />
      <area shape="rect" coords="13,101,62,153" href="';
	  echo $_SESSION['fichier'].'?lan=2'.$exten. '" alt="English version" title="English version" />
